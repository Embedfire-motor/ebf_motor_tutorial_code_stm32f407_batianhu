...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOA, M1_CURR_AMPL_V_Pin|M1_CURR_AMPL_W_Pin|M1_CURR_AMPL_U_Pin);

    HAL_GPIO_DeInit(GPIOB, M1_TEMPERATURE_Pin|M1_BUS_VOLTAGE_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PB15     ------> TIM1_CH3N
    */
    GPIO_InitStruct.Pin = M1_PWM_WH_Pin|M1_PWM_UH_Pin|M1_PWM_VH_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOC, M1_HALL_H3_Pin|M1_HALL_H2_Pin|M1_HALL_H1_Pin);
