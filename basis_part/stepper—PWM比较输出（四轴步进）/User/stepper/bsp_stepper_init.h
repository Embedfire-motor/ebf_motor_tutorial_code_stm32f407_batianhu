...
//通道1
//Motor 方向
#define MOTOR_DIR1_PIN                  	GPIO_PIN_7   
...
#define MOTOR_EN1_GPIO_CLK_ENABLE()    	  __HAL_RCC_GPIOD_CLK_ENABLE()

//Motor 脉冲
#define MOTOR_PUL1_PORT       			      GPIOE
#define MOTOR_PUL1_PIN             		    GPIO_PIN_9
#define MOTOR_PUL1_GPIO_CLK_ENABLE()		  __HAL_RCC_GPIOE_CLK_ENABLE()
...
//通道2
//Motor 方向
#define MOTOR_DIR2_PIN                  	GPIO_PIN_12
#define MOTOR_DIR2_GPIO_PORT            	GPIOE          
#define MOTOR_DIR2_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOE_CLK_ENABLE()

//Motor 使能
#define MOTOR_EN2_PIN                     GPIO_PIN_10
#define MOTOR_EN2_GPIO_PORT               GPIOE                       
#define MOTOR_EN2_GPIO_CLK_ENABLE()    	  __HAL_RCC_GPIOE_CLK_ENABLE()

//Motor 脉冲
#define MOTOR_PUL2_PORT       			      GPIOE
#define MOTOR_PUL2_PIN             		    GPIO_PIN_11
#define MOTOR_PUL2_GPIO_CLK_ENABLE()	  	__HAL_RCC_GPIOE_CLK_ENABLE()
...
//通道3
//Motor 方向
#define MOTOR_DIR3_PIN                  	GPIO_PIN_15
#define MOTOR_DIR3_GPIO_PORT            	GPIOE          
#define MOTOR_DIR3_GPIO_CLK_ENABLE()   	  __HAL_RCC_GPIOE_CLK_ENABLE()

//Motor 使能
#define MOTOR_EN3_PIN                  	  GPIO_PIN_9
#define MOTOR_EN3_GPIO_PORT            	  GPIOD                 
#define MOTOR_EN3_GPIO_CLK_ENABLE()    	  __HAL_RCC_GPIOD_CLK_ENABLE()

//Motor 脉冲
#define MOTOR_PUL3_PORT       			      GPIOE
#define MOTOR_PUL3_PIN             		    GPIO_PIN_13
#define MOTOR_PUL3_GPIO_CLK_ENABLE()		  __HAL_RCC_GPIOE_CLK_ENABLE()
...
//通道4
//Motor 方向
#define MOTOR_DIR4_PIN                  	GPIO_PIN_8
#define MOTOR_DIR4_GPIO_PORT            	GPIOD
#define MOTOR_DIR4_GPIO_CLK_ENABLE()   	  __HAL_RCC_GPIOD_CLK_ENABLE()

//Motor 使能
#define MOTOR_EN4_PIN                  	  GPIO_PIN_10
#define MOTOR_EN4_GPIO_PORT            	  GPIOD       
#define MOTOR_EN4_GPIO_CLK_ENABLE()    	  __HAL_RCC_GPIOD_CLK_ENABLE()

//Motor 脉冲
#define MOTOR_PUL4_PORT       			      GPIOE
#define MOTOR_PUL4_PIN             		    GPIO_PIN_14
#define MOTOR_PUL4_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOE_CLK_ENABLE()
